    ...
    Elseif ($selection -eq "2")
        {
            ...
            Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/bbkbrad/4DIAC/main/machine-bootstrap/workstation/bs-brad.ps1 -Credential $cred
            $success = 1
        }
    Elseif ($selection -eq "3")
        {
            ...
            Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/bbkbrad/4DIAC/main/machine-bootstrap/server/bs-server.ps1 -Credential $cred
            $success = 1
        }
    Elseif ($selection -eq "4")
        {
            ...
            Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/bbkbrad/4DIAC/main/machine-bootstrap/server/bs-adds.ps1 -Credential $cred
            $success = 1
        }
    Else{
